...
//first program (if/else method)
if (upperCase === "NE" && userTemperature <= 32) {
NSB.MsgBox(userName+", "+messages[0])
} else if (upperCase === "NE" && userTemperature > 32 && userTemperature <= 50) {
  NSB.MsgBox(userName+", "+messages[1])
} else if (upperCase === "FL" && userTemperature > 32 && userTemperature <= 50) {
  NSB.MsgBox(userName+", "+messages[2])
  } else if (upperCase === "FL" && userTemperature > 50 && userTemperature <= 70) {
